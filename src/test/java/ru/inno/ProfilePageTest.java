...
public class ProfilePageTest {
    ...
    public void getEmptyTableTest() {
        ProfilePage profilePage = new LoginPage().login(defaultUser);
    ...
    public void getSixBooksTest(){
        ProfilePage profilePage = new LoginPage().login(userWithSixBooks);
    ...
    public void deleteAllBooksTest() {
        ...
        ProfilePage profilePage = new LoginPage().login(userWithTwoBooks);
